...
path('websiteselection/', web_temp, name='web_sel'),
    ...
    path('dashboard_delete_book_blog_subscribers/<int:pk>/', dashboard_delete_book_blog_subscribers, name='dashboard_delete_book_blog_subscribers'),
    ...
    path('dashboard_sub_blog/', dashboard_sub_blog, name='dashboard_sub_blog'),
